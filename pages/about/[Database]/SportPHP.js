    ...
    <ul className="flex items-center">
      <li className="mr-2 md:mr-8 ml-2 md:ml-20">
        {darkMode ? (
          ...
          <h2 className="section_title">Sport Website</h2>
          <p className={`${
  darkMode ? 'about_description' : 'about_description-light'}`}>
 I made this project when I was 16 (back in 2018) and finished it when I was 17 for my Computer Science coursework subject. This is my first 
 ever RDBMS project using MySQL and phpMyAdmin as my database. Thanks to my computer science teacher, Cikgu Fauziah, that sparks
 my interest in programming and teach me how to develop database from scratch. 
 </p>
 <h2 className="section_title">What does it do?</h2>
 <p className={`${
  darkMode ? 'about_description' : 'about_description-light'}`}>
    This website is meant for sport competition registration, participants and users (wuth 3 levels which are admin, active and non-active).
    You can insert your data edit and delete. Basically a simpe website that is connected with a sport database.
    </p>
    <h2 className="section_title">How can I use this Sport Registration web</h2>
